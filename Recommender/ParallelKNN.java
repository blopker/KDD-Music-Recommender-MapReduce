...
//                System.out.println(chunk.getPath().toString());
    ...
    public void recommendSong(String activeUserFile, double threshold) throws FileNotFoundException {
        ...
        try {
            ...
            runPrediction(activeUserFile, threshold, chunks);
        } catch (IOException ex) {
            Logger.getLogger(ParallelKNN.class.getName()).log(Level.SEVERE, null, ex);
        }
     ...
     * Prediction Query
     */
    public static class PredictionMap extends MapReduceBase implements Mapper<Text, Text, Song, Iterator<Similarity>> {
    ...
    private int runPrediction(String activeUserFilename, double threshold, FileStatus[] chunks) {
        JobConf conf = new JobConf(getConf(), ParallelKNN.class);
